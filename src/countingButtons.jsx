...
// Single ButtonMain component to include all the other components
var ButtonMain = React.createClass({
...
React.render(<ButtonMain />, document.getElementById("countingButtons"))